...
Object.assign(locales.es.translations, {
  ...
  "Talk to your insurer": "Habla con tu aseguradora",
  "Report claims, fight rejected coverage, negotiate renewals, compare quotes, and chase every document.": "Comunica siniestros, pelea coberturas rechazadas, negocia renovaciones, compara presupuestos y persigue cada documento.",
  ...
  "Pay for less hassle, not more software": "Paga por tener menos líos, no más software",
  "Pick how much life admin": "Elige cuánto papeleo vital",
  "you want off your plate.": "quieres quitarte de encima.",
  "Try Geroa": "Prueba Geroa",
  "Free": "Gratis",
  "Give us one headache. See what your representative can do.": "Pásanos un marrón. Descubre lo que puede hacer tu representante.",
  "1 task": "1 gestión",
  "Calls and follow-up included": "Llamadas y seguimiento incluidos",
  "You approve every action": "Tú apruebas cada acción",
  "Try your first task": "Prueba tu primera gestión",
  "Geroa Starter": "Geroa Starter",
  "For the small tasks you keep putting off until next week.": "Para esas pequeñas gestiones que siempre dejas para la semana que viene.",
  "4 tasks each month": "4 gestiones al mes",
  "Bookings and cancellations": "Reservas y cancelaciones",
  "Start delegating": "Empieza a delegar",
  "Most popular": "Más popular",
  "Geroa Personal": "Geroa Personal",
  "For the bills, bookings, claims, and calls that keep coming back.": "Para las facturas, reservas, reclamaciones y llamadas que nunca se acaban.",
  "10 tasks each month": "10 gestiones al mes",
  "Negotiations and escalations": "Negociaciones y escalados",
  "Bookings and payment coordination": "Reservas y coordinación de pagos",
  "Cancel anytime": "Cancela cuando quieras",
  "Get your representative": "Consigue tu representante",
  "Geroa Plus": "Geroa Plus",
  "For busy people who want Geroa running the background of their life.": "Para gente ocupada que quiere que Geroa gestione el trabajo de fondo de su vida.",
  "30 tasks each month": "30 gestiones al mes",
  "Priority handling": "Atención prioritaria",
  "Complex multi-step requests": "Gestiones complejas de varios pasos",
  "Household support": "Soporte para todo el hogar",
  "Take back your time": "Recupera tu tiempo",
  "Geroa Unlimited": "Geroa Sin Límites",
  "Your personal operations department. Send the task and keep moving.": "Tu departamento personal de operaciones. Manda la tarea y sigue con tu vida.",
  "Unlimited tasks": "Gestiones ilimitadas",
  "Up to 10 active tasks at once": "Hasta 10 gestiones activas a la vez",
  "Fastest priority handling": "Máxima prioridad",
  "Household and family support": "Soporte para tu hogar y familia",
  "Complex negotiations and claims": "Negociaciones y reclamaciones complejas",
  "Delegate everything": "Delégalo todo",
  "No lock-in. External fees, deposits, and purchases are never included or charged without your approval.": "Sin permanencia. Las tasas, señales y compras externas no están incluidas y nunca se cobran sin tu aprobación."
});
